...
<label class="form-label">Enter Number3:</label>
...
<?php  
    ...
    {  
        ...
        {
            return ($number1 >= 20 && $number1 <= 50) || ($number2 >= 20 && $number2 <= 50) || ($number3 >= 20 && $number3 <= 50);
        }

        var_dump(test($number1,$number2,$number3));
}  
?>  
